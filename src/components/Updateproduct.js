...
const Updateproduct = ()=> {
    ...
    <div><nav className="navbar navbar-expand-lg bg-success p-3 text-center  ">
        ...
        <div className="row">
          <h3 className="text-success text-start">Update Product</h3>
            ...
            <div className="col-md-4 ">
                <div className="card text-center">
                    ...
                    <div className="card-body text-start">
                     ...
                     <input type="text" class="form-control" placeholder="Potatos" aria-label="Example text with button addon" aria-describedby="button-addon1"/>
                    </div>
                     ...
                     <input type="text" class="form-control" placeholder="45" aria-label="Example text with button addon" aria-describedby="button-addon1"/>
                    </div>
                      
                      <div class="input-group mt-3">
  
                     <input type="text" class="form-control" placeholder="25" aria-label="Example text with button addon" aria-describedby="button-addon1"/>
                    </div>
                    ...
                    <div className="card-footer text-muted text-start bg-white">
                      <button type="button" className="btn btn-success rounded-pill px-3">Update</button>
